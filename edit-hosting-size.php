            ...
            <form action="insert-hosting-size.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6">
                    	...
                    	<?php 
                    		$sql 		= "SELECT * FROM hostingsize WHERE id = '".$id."'";
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="hostingsizelimit" placeholder="<?php echo $rows['hostingsizelimit'];?>" id="hostingsizelimit" class="form-control" placeholder="GB" autofocus required="">
                        </div>
