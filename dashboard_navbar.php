    ...
    <div class="menu-sidebar__content js-scrollbar1">
        <nav class="navbar-sidebar">
            <ul class="list-unstyled navbar__list">
                ...
                <li>
                    <a href="#" class="js-arrow">
                        <i class="fa fa-server" aria-hidden="true"></i> Hosting
                    </a>
                     <ul class="list-unstyled navbar__sub-list js-sub-list">
                        <li>
                            <a href="all-hosting.php"> All </a>
                        </li>
                        <li>
                            <a href="hosting-linkon.php"> Linkon </a>
                        </li>
                        <li>
                            <a href="hosting-adil.php"> Adil </a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="list-unstyled navbar__sub-list js-sub-list">
                        ...
                        <li>
                            <a href="all-client-dashboard.php"> All Clients </a>
                        </li>
                        <li>
